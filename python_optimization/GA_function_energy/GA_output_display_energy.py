...
#情報表示###############################################################################################################
def output_info(N_INC, N_TRANS, N_IND, get_top_cities, total_energy_info, gen_info, sumgen, best_individual, start_time_count, current_time, output_directory, lock, energy_2D, counter, localmark, lock2):    
