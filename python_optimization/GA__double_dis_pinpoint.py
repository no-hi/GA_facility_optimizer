...
if __name__ == '__main__':
    try:
        ...
        lock = manager.Lock()
        lock2 = manager.Lock()
        double_2D_origin = [[[] for _ in range(N_TRANS_INITIAL, N_TRANS_MAX + 1, 10)] for _ in range(N_INC_INITIAL, N_INC_MAX + 1, 10)]
        ...
        energy_2D_origin = [[[] for _ in range(N_TRANS_INITIAL, N_TRANS_MAX + 1, 10)] for _ in range(N_INC_INITIAL, N_INC_MAX + 1, 10)]
