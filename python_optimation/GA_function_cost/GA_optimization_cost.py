...
def GA_optimization(N_INC, N_TRANS, current_time, output_directory, lock, cost_2D, counter):
    ...
    output_display.output_info(N_INC, N_TRANS, N_IND, get_top_cities, total_cost_info, gen_info, sumgen, best_individual, start_time_count, current_time, output_directory, lock, cost_2D, counter, localmark)
