...
colors = cm.Set3(np.linspace(0, 1, len(inc_blocks)))  # カラーマップから色を取得
...
for _, row in fazility_municipalities.iterrows():
    ...
    ax.scatter(representative_point.x, representative_point.y, color="gray", s=row["施設規模"]*1, edgecolor="black", marker="o")  # 施設サイズのスケールを調整
